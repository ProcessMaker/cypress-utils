export default{
    ...
    //CRUD Processes:
    archiveProcessesPermission:'[id="permission_archive-processes"]',
    createProcessCategoriesPermission:'[id="permission_create-process-categories"]',
    createProcessesPermission: '[id="permission_create-processes"]',
    deleteProcessCategoriesPermission:'[id="permission_delete-process-categories"]',
    editProcessCategoriesPermission:'[id="permission_edit-process-categories"]',
    editProcessesPermission: '[id="permission_edit-processes"]',
    exportProcessesPermission:'[id="permission_export-processes"]',
    importProcessesPermission:'[id="permission_import-processes"]',
    viewProcessCategoriesPermission: '[id="permission_view-process-categories"]',
    viewProcessesPermission: '[id="permission_view-processes"]',
