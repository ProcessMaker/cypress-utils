    ...
    */
    ...
    verifyConfigOfStartEventAndConfig(elementName, permissionObject) {
        ...
        const OptionSelected = "//label[text()='nameType']/parent::div//div[@class='multiselect__tags']//span";
            ...
            cy.wait(3000);
            cy.xpath(elementStartEventXpath.replace('nameElem', elementName)).should('exist');
            cy.wait(4000);
            cy.xpath(elementStartEventXpath.replace('nameElem', elementName)).first().click({force:true});
                    ...
                    cy.xpath(OptionSelected.replace('nameType', 'user')).invoke('text')
                        .then(text => {
                            if (text !== fullName) {
                                ...
                                cy.wait(5000);
                                cy.xpath(startPemrissions_opInputSelector.replace('nameType', 'user')).type(userName,{delay:200}).should('have.value', userName);
                                cy.wait(7000);
