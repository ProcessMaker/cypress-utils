...
export class Execution {
    ...
    async actionsAndAssertionsOfTCP42239A(){
        ...
        cy.xpath('//input[@name="image2"]').check({delay: 1000});
        cy.xpath('//input[@name="image2"]').uncheck({delay: 1000});
        cy.xpath('//span[@class="required-asterisk"]').should('be.visible');
        cy.xpath('//input[@name="image1"]').check({delay: 1000});
        cy.xpath('//input[@name="image1"]').uncheck({delay: 1000});
        ...
        request.openRequestById(requestID);
        cy.reload();
        await cy.xpath('//tr[@item-index="0"]/td/a').should('contain.text',"Form Task 2").contains('Form Task 2').click({force:true});
        cy.wait(2000);
